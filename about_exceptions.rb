...
class AboutExceptions < EdgeCase::Koan
  ...
  def test_exceptions_inherit_from_Exception
    ...
    assert_equal PP::ObjectMixin, MySpecialError.ancestors[5]
    assert_equal Kernel, MySpecialError.ancestors[6]
    assert_equal BasicObject, MySpecialError.ancestors[7]
